...
function(set_target_properties_plugin target)
  ...
  install(TARGETS ${target} RUNTIME DESTINATION "bin/64bit" LIBRARY DESTINATION "bin/64bit")
...
function(target_install_resources target)
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/data")
    ...
    install(DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}/data/" DESTINATION "data" USE_SOURCE_PERMISSIONS)
...
function(target_add_resource target resource)
  ...
  install(FILES "${resource}" DESTINATION "data" COMPONENT Runtime)
